      ...
      <div className="pt-[80px] h-screen mb-8">
        <div className="grid grid-cols-8 max-sm:grid-cols-1 max-sm:flex flex-col-reverse justify-center h-full">
          <div className="col-span-5 flex flex-col justify-center pl-20 max-lg:pl-4">
              ...
              <div className="font-bold text-5xl max-md:text-3xl max-sm:text-2xl mb-2">DEVRAJ KUMAR</div>
              <div className="my-4 max-sm:text-sm">As a budding MERN stack developer, I am keen to put my theoretical understanding into practical use within the software domain. I am actively exploring opportunities to contribute and enhance my skills through engaging internship experiences this summer.</div>
